    ...
    <div className="stack" style={{ gap: 'var(--s-5)' }}>
      ...
      */}
      ...
      <SectionTabs
        ...
        tabs={[
          {
            href: '/operator/verification/integration?env=sandbox',
            label: ENVIRONMENT_LABELS.sandbox,
          },
          ...
          {view.callbackUrl ? (
            <details>
              ...
              >
                ...
                <div className="row">
                  <button type="submit" className="btn btn-secondary" data-role="save-callback">
                    تحديث
                  </button>
                </div>
              </form>
