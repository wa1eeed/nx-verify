      ...
      <div className="person-head">
        ...
        {canCheck ? (
          <form action={action}>
            ...
            <button type="submit" className="btn-secondary btn-small" data-role="check-manager">
...
function SectionForm({
  ...
  return (
    <form action={action} className="row" style={{ gap: 'var(--s-2)' }} data-role="section-form">
      ...
      <button type="submit" className="btn-secondary btn-small" data-role="check-section">
