  ...
  return (
    <div className="stack" data-role="shared-profile" style={{ gap: 'var(--s-5)' }}>
      ...
      <section className="card" data-role="what-this-is">
        <p className="faint" style={{ margin: 0 }}>
          كل حقل أعلاه سُحب من جهته الرسمية في التاريخ المكتوب عليه، ولم يُدخله أحد يدوياً. «حديث»
          تعني أن الحقل ما زال داخل مدة صلاحيته، و«منتهي الصلاحية» تعني أن المعرفة قديمة ولا تعني
          وجود مشكلة.
        </p>
      </section>
    </div>
