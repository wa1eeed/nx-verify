...
export function VerificationsLog({ view }: { view: VerificationsLogView }): ReactElement {
  return (
    <div className="stack" style={{ gap: 'var(--s-5)' }}>
      <PageHeader
        title="عمليات التحقق"
        subtitle="كل عملية تحقق تمت على عملائك، بمرجعها ونتيجتها ورسمها."
        action={
          <a className="btn-primary" href="/customers/new">
            تحقق جديد
          </a>
        }
      />
      ...
      <section className="grid" data-role="run-counts">
        ...
        <a className="stat stat-link" href="/verifications/reviews">
