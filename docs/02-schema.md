...
> **هذا المستند هو المخطط كما صُمّم وأسبابه.** ما هو موجود فعلاً في القاعدة اليوم، عموداً بعمود وسياسةً بسياسة، في [`reference/database.md`](reference/database.md)، وهو المولَّد من الترحيلات. عند أي اختلاف، الترحيلات هي المرجع.
