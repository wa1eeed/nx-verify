...
const API_PRODUCTS: readonly SeedProduct[] = [
  ...
  },
  {
    ...
    fieldMap: [
      ...
      { stepKey: 'ownership', sourcePath: '$.account_currency', fieldPath: 'account.currency' },
      {
        stepKey: 'ownership',
        sourcePath: '$.verification_method',
        fieldPath: 'account.verification_method',
      },
      { stepKey: 'ownership', sourcePath: '$.bank_name', fieldPath: 'account.bank' },
      { stepKey: 'ownership', sourcePath: '$.bank_swift', fieldPath: 'account.swift_code' },
      { stepKey: 'ownership', sourcePath: '$.bank_code', fieldPath: 'account.bank_code' },
      {
        stepKey: 'ownership',
        sourcePath: '$.bank_clearing_id',
        fieldPath: 'account.clearing_id',
      },
    ],
  },
  {
    ...
    fieldMap: [
      ...
      { stepKey: 'name', sourcePath: '$.name_provided', fieldPath: 'holder.name_provided' },
      { stepKey: 'name', sourcePath: '$.name_retrieved', fieldPath: 'holder.name_retrieved' },
    ],
  },
  {
    /**
