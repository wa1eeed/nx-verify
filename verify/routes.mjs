...
export const ROUTES = [
  ...
  { name: 'portal-monitoring', path: '/customers/monitoring', as: 'portal' },
  ...
  { name: 'portal-onboarding-new', path: '/verifications/onboarding/new', as: 'portal' },
  ...
  { name: 'portal-webhooks', path: '/settings/developers/webhooks', as: 'portal' },
  ...
  { name: 'portal-sso', path: '/settings/sso', as: 'portal' },
  { name: 'portal-audit', path: '/settings/audit', as: 'portal' },
  ...
  { name: 'operator-callbacks', path: '/operator/verification/callbacks', as: 'operator' },
  { name: 'operator-keys', path: '/operator/verification/keys', as: 'operator' },
